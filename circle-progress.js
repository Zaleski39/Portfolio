                        ...
                        var r = (function () {
                            ...
                            return (
                                ...
                                (x.prototype.stop = function (t) {
                                    return (
                                        (this._isTweening = !1), (this._isPaused = !1), (this._timeoutHandler = p), t && (d(this._currentState, this._targetState), m(this, "afterTweenEnd"), this._finish.call(this, this._currentState)), this
                                    );
                                }),
                                ...
                                d(x, { now: l, each: c, tweenProps: _, tweenProp: w, applyFilter: m, shallowCopy: d, defaults: g, composeEasingObject: y }),
                                ...
                                (t._filterArgs = []),
                                    (r.interpolate = function (e, n, i, o) {
                                        ...
                                        var h,
                                            ...
                                            p,
                                            c,
                                            d = ((h = e), (f = s), (l = n), (p = i), (c = a), r.tweenProps(p, f, h, l, 1, 0, c));
            ...
            5: [
                function (t, e, n) {
                    var r = t("shifty"),
                        ...
                        s = function (t, e) {
                            (e = i.extend({ duration: 3000, easing: "linear", from: {}, to: {}, step: function () {} }, e)), (this._path = t), (this._opts = e), (this._tweenable = null);
                        ...
                        s = function t(e, n) {
                            ...
                            if (0 !== arguments.length) {
                                ...
                                (this._container = o),
                                    ...
                                    (this.text = null),
                                    this._opts.text.value && ((this.text = this._createTextElement(this._opts, this._container)), this._container.appendChild(this.text));
            ...
            if (o.length) {
                ...
                for (
                    n =
                        ...
                        (g = void 0),
                        (_ = void 0),
                        (_ = { height: a.innerHeight, width: a.innerWidth }).height || (((d = s.compatMode) || !t.support.boxModel) && (_ = { height: (g = "CSS1Compat" === d ? u : s.body).clientHeight, width: g.clientWidth })),
                        _),
                        r = r || { top: a.pageYOffset || u.scrollTop || s.body.scrollTop, left: a.pageXOffset || u.scrollLeft || s.body.scrollLeft };
                    e < o.length;
                    e++
                )
